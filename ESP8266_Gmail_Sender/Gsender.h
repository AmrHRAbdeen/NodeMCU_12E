...
class Gsender
{
  ...
  email: rubbish.notification2018@gmail.com
  PSK: rubbish2018
  */
    protected:
        Gsender();
    private:
        ...
        const char* EMAILBASE64_LOGIN = "cnViYmlzaC5ub3RpZmljYXRpb24yMDE4QGdtYWlsLmNvbQ==";
        const char* EMAILBASE64_PASSWORD = "cnViYmlzaDIwMTg=";
        const char* FROM = "Rubbish.Notifications@gmail.com";
